<template>
    ...
    <div class="faqRow">
        <div class="FAQ">
            ...
            <br>
            <p class="ptext">Durante todo o ano o Eco-escolas realiza várias atividades que têm como objetivo 
        ...
        <div class="FAQ">
            ...
            <br>
            <p class="ptext">Achas que consegues completar todas as missões? Segue as instruções de cada missão para a completar e explora 
                a plataforma enquanto te divertes!</p>
            </div>
        </div>
    </div>
    ...
    <div class="faqRow">
        ...
        <div class="FAQ">
            ...
            <br>
            <p class="ptext">Quanto mais ativo fores, mais pontos terás e quantos mais pontos tiveres, mais alto ficas no quadro de líderes! 
        ...
        <div class="FAQ">
            ...
            <br>
            <p class="ptext">Preenche o questionário e deixa o Eco-Escolas orgulhoso! Informa-os da tua sustentabilidade.</p>
            </div>
        </div>
    </div>
</div>
