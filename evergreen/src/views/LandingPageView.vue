<template>
  <div>
    <h1>Tudo o que precisas para o teu percurso</h1>
   <h1>no Eco-Escolas num só sítio com</h1>
   <h1 class="underlinegreen">Evergreen</h1>
  </div>
  <div id="div1">
    <h1>Participa em atividades</h1>
...
Aposto que vais adorar pelo menos uma e, com sorte vais adorar todas! Mas para descobrires isso tens que te inscrever em pelo menos uma!</p>
   <button>Começa já</button>
  </div>
  <div id="div2">
    <h1>Regista Ocorrências</h1>
...
Completa todas as missões que temos para ti e explora tudo o que o Eco-Escolas tem para ofereçer enquanto te divertes!</p>
  ...
  <div>
    <h1>Estás pronto para dar o próximo passo para ajudar o teu planeta?</h1>
   <button>Começa já</button>
  </div>
