<template>
  <div class="div" id="firstdiv">
    <div id="text0">
      <h1>Tudo o que precisas para o teu percurso <br> no Eco-Escolas num só sítio com</h1>
      <h1 class="gradientGreen padding"><span>Evergreen</span></h1>
      <p >Damos-te as boas-vindas ao Evergreen e à comunidade Eco-Escolas! <br> Pronto para tornares o mundo mais verde?</p>
      <RouterLink to="/signUp">
        <button class="btn-page" id="btn0">
          Começar
        </button>
      </RouterLink>
    </div>
  ...
  <div>
    ...
    <div class="midDiv" id="div2">
      ...
      <div id="text2">
        ...
        <p class="desc">Já alguma vez reparaste que a torneira da casa de banho da tua escola estava a pingar? Ou que a luz da sala de aula estava a piscar? Esta é a tua oportunidade de fazer algo acerca disso!
